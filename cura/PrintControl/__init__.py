...
from cura.PrintControl.PrintSetting import PrintSetting
...
class CuraPrintControl(QObject):
    ...
    def __new__(cls, application: Optional["CuraApplication"] = None):
        if cls.__instance is None:
            ...
            cls.__instance = super(CuraPrintControl, cls).__new__(cls)
            cls._application = application
        return cls.__instance

    def __init__(self, application: Optional["CuraApplication"] = None) -> None:
        super().__init__(parent = CuraPrintControl._application)

        # Backups API
        self._print= PrintSetting(self._application)

    @pyqtProperty(QObject, constant=True)
    def print(self) -> "PrintSetting":
        return self._print
